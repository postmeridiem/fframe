...
Color constDividerColorDark = const Color(0xB21B1B1B);

// color that sets the main background behind everything
Color constBackgroundColorDark = const Color(0xFF0E0D0D);
Color constOnBackgroundColorDark = const Color(0xFFEEEEEE);
...
// color for dividers and lines
Color constDividerColorLight = const Color(0xB2B6B6B6);

// color that sets the main background behind everything
Color constBackgroundColorLight = const Color(0xFFECE2E2);
Color constOnBackgroundColorLight = const Color(0xFF1B020B);
Color constOnBackgroundColorFadedLight = const Color(0xFFDAC8CF);
