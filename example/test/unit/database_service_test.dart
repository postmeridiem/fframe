...
void main() {
  ...
  timedGroup('DatabaseService', () {
    setUp(() {
      setupUnitTests();
    });

    timedTest('should work with default instances when Firebase is initialized', () {
    ...
    timedTest('should accept injected Firebase instances', () {
    ...
    timedTest('should generate document IDs using injected Firestore instance', () {
      final fakeFirestore = FakeFirebaseFirestore();
