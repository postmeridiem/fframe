...
//   factory SwimlanesTask.fromFirestore(DocumentSnapshot<Map<String, dynamic>> snapshot, SnapshotOptions? snapshotOptions) {
//     Map<String, dynamic> json = snapshot.data()!;
//     String iconName = json['icon'] == null ? 'trip_origin_outlined' : json['icon'] as String;
...
//       "createdBy": createdBy ?? FirebaseAuth.instance.currentUser?.email ?? "Anonymous",
