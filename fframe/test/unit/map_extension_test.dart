...
void main() {
  group('MapExtensions', () {
    ...
    test('firstWhereOrNull should return the value when the condition is met', () {
      final result = testMap.firstWhereOrNull((key, value) => value == 2);
      expect(result, 2);
    });

    test('firstWhereOrNull should return the first value when multiple conditions are met', () {
      final result = testMap.firstWhereOrNull((key, value) => value > 1);
      expect(result, 2);
    });

    test('firstWhereOrNull should return null when the condition is not met', () {
      final result = testMap.firstWhereOrNull((key, value) => value == 4);
      expect(result, null);
    });

    test('firstWhereOrNull should return null for an empty map', () {
      final Map<String, int> emptyMap = {};
      final result = emptyMap.firstWhereOrNull((key, value) => value == 1);
      expect(result, null);
    });

    test('firstWhereOrNull should work with different key and value types', () {
