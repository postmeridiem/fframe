...
import 'package:fframe/material/data_table_extended.dart';
...
class PaginatedDataTableExtended extends StatefulWidget {
  ...
  /// To modify the border or background color of the [PaginatedDataTableExtended], use
  ...
  @override
  PaginatedDataTableExtendedState createState() => PaginatedDataTableExtendedState();
}

/// Holds the state of a [PaginatedDataTableExtended].
///
/// The table can be programmatically paged using the [pageTo] method.
class PaginatedDataTableExtendedState extends State<PaginatedDataTableExtended> {
