...
///
/// {@tool dartpad}
/// This sample shows how to display a [DataTableExtended] with three columns: name, age, and
...
///
/// {@tool dartpad}
/// This sample shows how to display a [DataTableExtended] with alternate colors per
/// row, and a custom color for when the row is selected.
///
/// ** See code in examples/api/lib/material/data_table/data_table.1.dart **
/// {@end-tool}
///
/// [DataTableExtended] can be sorted on the basis of any column in [columns] in
...
class DataTableExtended extends StatelessWidget {
  ...
  ///
  /// This can be used to clip the content within the border of the [DataTableExtended].
  ///
  ...
  Widget _buildDataCell({
    ...
    final double? effectiveDataRowHeight = dataRowHeight ?? dataTableTheme.dataRowMinHeight ?? themeData.dataTableTheme.dataRowMinHeight;
    label = Container(
      padding: padding,
  ...
  Widget build(BuildContext context) {
    ...
    final double effectiveCheckboxHorizontalMarginStart = checkboxHorizontalMargin ?? dataTableTheme.checkboxHorizontalMargin ?? theme.dataTableTheme.checkboxHorizontalMargin ?? effectiveHorizontalMargin;
    final double effectiveCheckboxHorizontalMarginEnd = checkboxHorizontalMargin ?? dataTableTheme.checkboxHorizontalMargin ?? theme.dataTableTheme.checkboxHorizontalMargin ?? effectiveHorizontalMargin / 2.0;
...
/// See also:
///
///  * [DataTableExtended], which makes use of [TableRowInkWell] when
